...
#define TDR_METALIB_TFRAMEHEAD_VERSION 	35 /*version of metalib*/
#endif

#ifndef TDR_METALIB_TFRAMEHEAD_HASH 
#define TDR_METALIB_TFRAMEHEAD_HASH 	"b36cc614530d6629f777f0c0c43fbad2" /*hash of metalib*/
#endif
...
enum tagTFRAMEHEAD_CMD_ID 
{
    ...
    TFRAMEHEAD_CMD_SERVICE_SETROUTING_REQ = 51, 	/* 路由跳转 */
    TFRAMEHEAD_CMD_SERVICE_SETROUTING_RSP = 52, 	/* 路由跳转 */
    TFRAMEHEAD_CMD_SERVICE_ROUTING_NOTIFY = 53, 	/* 路由跳转通知 */
};
...
enum tagTCONNAPI_ACCOUNT 
{
    ...
    TCONNAPI_ACCOUNT_APPLE_OPENID = 4102, 
    ...
    TCONNAPI_ACCOUNT_MINIGAME_WX = 39, 	/* 与itop_channel_id.h中的TCONND_ITOP_CHANNEL_MINIGAME_WX一致 */
    TCONNAPI_ACCOUNT_MINIGAME_QQ = 40, 	/* 与itop_channel_id.h中的TCONND_ITOP_CHANNEL_MINIGAME_QQ一致 */
};
...
enum tagTCONNAPI_CLIENT_TYPE 
{
    ...
    TCONNAPI_CLIENT_TYPE_HARMONY = 140, 
};
...
#define MAX_SVC_ROUTING_BIZ_DATA_LEN                     	1024 	/* 路由跳转携带的包大小 */
#define MAX_NAME_LENGTH                                  	128 	/* 服务名字最大长度 */
...
enum tagTFRAMEHEAD_STOP_REASON 
{
    ...
    TFRAMEHEAD_REASON_TCONND_STOP = 37, 	/* tconnd进程停止通知 */
    TFRAMEHEAD_REASON_PLUGIN_STOP = 38, 	/* tconnd插件停止通知 */
    TFRAMEHEAD_REASON_QUEUE_BUSY = 39, 	/* 目的实例错误 */
    TFRAMEHEAD_REASON_COUNT = 40, 	/* 加错误码后记得改内部和外部两个tconnapi.cpp里的tconnd_close_string[] */
};
...
enum tagTFRAMEHEAD_SETROUTING_RESULT 
{
    ...
    SETROUTING_RESULT_FAIL_SVR_FAIL = 6, 	/* 设置路由的目标server失败,一般是svr不存在导致 */
};
...
enum tagTFRAMEHEAD_FLAG 
{
    ...
    TFRAMEHEAD_FLAG_UNRELIABLE = 2, 	/* If this bit is set. The message is treated as unreliable. */
    TFRAMEHEAD_FLAG_UNRELIABLE_ALTERNATE_ROUTE = 4, 	/* If this bit is set. The message is send on both default and alternate route. */
};
...
enum tagINTF_TYPE 
{
    INTF_TYPE_DEFAULT = 0, 	/* 默认链路 */
    INTF_TYPE_WIFI = 1, 	/* Wifi链路 */
    INTF_TYPE_4G = 2, 	/* 4G链路 */
    INTF_TYPE_UNKNOWN = 3, 	/* 非4G链路的辅助链路 */
};
...
struct tagTFrameCmdServiceSetRoutingReq;
typedef struct tagTFrameCmdServiceSetRoutingReq                    	TFRAMECMDSERVICESETROUTINGREQ;
typedef struct tagTFrameCmdServiceSetRoutingReq                    	*LPTFRAMECMDSERVICESETROUTINGREQ;

struct tagTFrameCmdServiceSetRoutingRsp;
typedef struct tagTFrameCmdServiceSetRoutingRsp                    	TFRAMECMDSERVICESETROUTINGRSP;
typedef struct tagTFrameCmdServiceSetRoutingRsp                    	*LPTFRAMECMDSERVICESETROUTINGRSP;

struct tagTFrameCmdServiceRoutingNotify;
typedef struct tagTFrameCmdServiceRoutingNotify                    	TFRAMECMDSERVICEROUTINGNOTIFY;
typedef struct tagTFrameCmdServiceRoutingNotify                    	*LPTFRAMECMDSERVICEROUTINGNOTIFY;
...
struct tagTIPInfo
{
    ...
    uint16_t wIntf_type;                              	/*  Ver.35  Bind Macrosgroup:INTF_TYPE,*/
    uint32_t dwRecv_udp_packet_count;                 	/*  Ver.35  */
    uint32_t dwRecv_udp_packet_valid_count;           	/*  Ver.35  */
    uint32_t dwRecv_udp_packet_toolate_count;         	/*  Ver.35  */
    uint32_t dwRecv_udp_packet_late_lt_low_limit;     	/*  Ver.35  */
    uint32_t dwRecv_udp_packet_late_gt_low_limit_lt_high_limit; 	/*  Ver.35  */
    uint32_t dwRecv_udp_packet_late_gt_high_limit;    	/*  Ver.35  */
    uint32_t dwRecv_udp_packet_lost_count;            	/*  Ver.35  */
    uint32_t dwRecv_udp_packet_unorder_count;         	/*  Ver.35  */
    uint32_t dwRecv_udp_packet_maxseq;                	/*  Ver.35  */
};
...
struct tagTFrameCmdInProc
{
    ...
    uint32_t dwAlternateLinkTimeStampMs;              	/*  Ver.35 保留字段 */
    uint32_t dwIs_down_alternate_link_enabled;        	/*  Ver.35 保留字段 */
    uint8_t bAlternateLinkCount;                      	/*  Ver.35 是否携带LWIP相关信息 */
    TIPINFO astSIPInfo[20];                           	/*  Ver.35 ClientLinks, SIPInfo[0] for default link. */
};
...
struct tagTFrameCmdSetRouting
{
    ...
    int32_t iBizDataLen;                              	/*  Ver.33  */
    uint8_t szBizData[MAX_SVC_ROUTING_BIZ_DATA_LEN];  	/*  Ver.33 携带的业务数据 */
};
...
struct tagTFrameCmdServiceSetRoutingReq
{
    char szServiceName[MAX_NAME_LENGTH];             
    char szUserData[MAX_NAME_LENGTH];                
    int32_t iBizDataLen;                             
    uint8_t szBizData[MAX_SVC_ROUTING_BIZ_DATA_LEN];  	/*   携带的业务数据 */
    int32_t iNewID;                                   	/*  Ver.34 连接在新逻辑服务器上的索引,含义同TFrameHead中的字段 */
};
...
struct tagTFrameCmdServiceRoutingNotify
{
    ...
    uint8_t szBizData[MAX_SVC_ROUTING_BIZ_DATA_LEN];  	/*   携带的业务数据 */
    int32_t iNewID;                                   	/*  Ver.34 连接在新逻辑服务器上的索引,含义同TFrameHead中的字段 */
    uint64_t ullNewExtend;                            	/*  Ver.34 连接新的Extend值 */
};
...
union tagTFrameCmdData
{
    ...
    TFRAMECMDSERVICESETROUTINGREQ stServiceSetRoutingReq; 	/* TFRAMEHEAD_CMD_SERVICE_SETROUTING_REQ, Ver.32 service模式下跳转路由,gs->tconnd */
    TFRAMECMDSERVICESETROUTINGRSP stServiceSetRoutingRsp; 	/* TFRAMEHEAD_CMD_SERVICE_SETROUTING_RSP, Ver.32 service模式下跳转路由,tconnd->gs */
    TFRAMECMDSERVICEROUTINGNOTIFY stServiceRoutingNotify; 	/* TFRAMEHEAD_CMD_SERVICE_ROUTING_NOTIFY, Ver.32 service模式下跳转路由,tconnd->new gs */
};
