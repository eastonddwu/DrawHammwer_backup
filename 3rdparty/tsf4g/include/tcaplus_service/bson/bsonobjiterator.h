    ...
    public:
        ...
        */
        ...
        BSONElement next( bool checkEnd ) {
			if(!( _pos <= _theend ))
			{
				msgasserted(10012, "(next( bool checkEnd ) error,reason:(!( _pos <= _theend ))"); 
		 	}
            ...
            if ( checkEnd ) {
				...
				if(!( maxLen > 0 ))
				{
					msgasserted(10013, "(next( bool checkEnd ) error,reason:(!( maxLen > 0 ))"); 
				}			
            }
        ...
        BSONElement next() 
		{
			if(!( _pos <= _theend ))
			{
				msgasserted(10012, "next() error,reason:(!( _pos <= _theend ))"); 
		 	}
        ...
        BSONElement operator*() 
		{
			if(!( _pos <= _theend ))
			{
				msgasserted(10012, "operator*() error,reason:(!( _pos <= _theend ))"); 
		 	}
