    ...
    */
    ...
    public:
        ...
        */
        ...
        explicit BSONObj(SharedBuffer shared_buffer) 
            : _objdata(shared_buffer.get() ? shared_buffer.get() : BSONObj().objdata())
            , _sharedBuffer(shared_buffer)
        {
        }

        bool isShared() { return _sharedBuffer; } // use operator bool
        ...
        */
        ...
        /** @return direct simple child num in this BSON object */
        int simpleChildNum() const {
            return readInt(objdata() + BO_HEADER_OBJ_SIZE);
        }
        ...
        bool isEmpty() const { return objsize() <= BO_HEADER_TOTAL + BO_ELEMENT_TYPE; }
        ...
        */
        ...
        BSONElement firstElement() const { return BSONElement(objdata() + BO_HEADER_TOTAL ); }
        ...
        */
        const char * firstElementFieldName() const {
            const char *p = objdata() + BO_HEADER_TOTAL;
            return *p == EOO ? "" : p + BO_ELEMENT_TYPE;
        }
        ...
        */
        ...
        bool operator==( const BSONObj& other ) const { return 0==strcmp((*this).toString().c_str(),other.toString().c_str()); }
        ...
        */
        ...
        void appendSelfToBufBuilder(BufBuilder& b) const 
		{
			...
			if(!( objsize() != 0 ))
			{
				msgasserted(10008, "appendSelfToBufBuilder(BufBuilder& b) error,reason:(!( objsize() != 0 ))"); 
			}
