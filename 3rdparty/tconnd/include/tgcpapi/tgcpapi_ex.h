...
/// @return =0, success
///         !0, fail, 调用tgcpapi_error_string()获取错误原因
int tgcpapi_set_refresh_token(HTGCPAPI pHandler, const char* pszRefreshToken,
                              int iRefreshTokenLen, int iExpire = 0);
...
/// @return =0, success
///         !0, fail, 调用tgcpapi_error_string()获取错误原因
int tgcpapi_set_auth_code(HTGCPAPI pHandler, const char* pszAuthCode,
                          int iCodeLen);

////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @brief  设置rsv
///
/// @param[in, out]  handler tgcpapi句柄指针
/// @param[in]  rsv   rsv值
/// @param[in]  rsv_len   rsv的长度
/// @return =0, success
///         !0, fail, 调用tgcpapi_error_string()获取错误原因
int tgcpapi_set_rsv(HTGCPAPI handler, const char* rsv, int rsv_len);
...
/// @return =0, success
///
int tgcpapi_set_start_transdata(HTGCPAPI pHandler, int iReserveInt,
                                const char* pszData, int iDataLen);

////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @brief  设置平台类型
///
/// @param[in, out]  handler        tgcpapi句柄指针
/// @param[in]       platformid     平台id
void tgcpapi_set_platform(HTGCPAPI handler, ePlatformID platformid);
