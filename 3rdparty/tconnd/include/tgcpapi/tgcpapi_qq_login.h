...
int tgcpapi_qq_login_st_init(HTGCPAPI a_pHandle, int a_iServiceID,
                             ePlatformID a_iPlatformID, int a_iBuffLen,
                             int a_iAppID, TGCPQQUnifiedAuthInfo* a_pstAuthInfo,
...
int tgcpapi_make_qqunify_authinfo(TGCPQQUnifiedAuthInfo* a_pstUnifyAuthInfo,
                                  unsigned long long a_uUin, char* a_pszSvrKey, char* a_pszSessionKey,
                                  unsigned int a_uCltIP);
...
///         通常调用本函数生成测试签名
int tgcpapi_create_test_signature(TGCPQQUnifiedAuthInfo* a_pstUnifyAuthInfo,
                                  unsigned long long a_uUin, unsigned int a_uCltIP);
